...
namespace personal_attendanse_system.Areas.Identity.Pages.Account.Manage
{
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                */
                ...
                // 1. Manually set the new email using SetEmailAsync
                var code = await _userManager.GenerateChangeEmailTokenAsync(user, Input.NewEmail);
                ...
                StatusMessage = "Your email has been changed and confirmed.";
